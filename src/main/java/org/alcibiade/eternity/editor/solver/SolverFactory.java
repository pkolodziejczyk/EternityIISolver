...
import org.alcibiade.eternity.editor.solver.backtracking.IterativePathSolverMkIV;
...
public class SolverFactory {
	...
	public static final String LABEL_ITPATHMKIV = "Iterative Path MkIV";
	...
	public static EternitySolver createSolver(String type, GridModel pieces, GridModel solution,
		...
		} else if (LABEL_ITPATHMKIV.equalsIgnoreCase(type)) {
			solver = new IterativePathSolverMkIV(pieces, solution, clusterManager, path);
	...
	public static boolean isSolverPathSensitive(String type) {
		return LABEL_ITPATHMKI.equals(type) || LABEL_ITPATHMKII.equals(type)
				|| LABEL_ITPATHMKIII.equals(type) || LABEL_ITPATHMKIV.equals(type);
	}
}
